...
namespace ExtensionMethods
{
    ...
    public static class ComplexExtensions
    {
        ...
        private static IComplex Multiply(this IComplex complex, double scalar) =>
            new Complex(complex.Real * scalar, complex.Imaginary * scalar);

        private static IComplex Divide(this IComplex complex, double scalar) => complex.Multiply(1.0 / scalar);
    }
}
